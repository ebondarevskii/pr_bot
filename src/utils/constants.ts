...
export const PIMLICO_CONFIG = {
  BUNDLER_URL: import.meta.env.VITE_PIMLICO_BUNDLER_URL || 'https://api.pimlico.io/v2/137/bundler',
  PAYMASTER_URL: import.meta.env.VITE_PIMLICO_BUNDLER_URL || 'https://api.pimlico.io/v2/137/rpc',
